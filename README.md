...
## Discription
This mini project is the final assignment for Quantitative Methods in Finance (FRE-GY 6083). Originally, the project aims to evaluate Disney (DIS) options for the coming week using both the Binomial Tree Model and the Black-Scholes-Merton Model. I have extended the project's scope to allow the application to any stock and maturity date, as outlined in the following sections.
